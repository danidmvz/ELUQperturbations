...
for j=1:nt_2save-1            % loop used to save in time
    for dummyVar=1:nt_2iter-1 % loop that iterates in every time step to save
        switch timeMethod
            case 1 % EE
                k1 = FUNC_rhsMoP2D_o0_inertial(time       ,                        y,flowType,dataFlow,f1Type,npx,npy,taup);
                y  = y+dt*k1;
            case 2 % RK2
                disp('not coded')
            case 3 % RK3 TVD
                k1 = FUNC_rhsMoP2D_o0_inertial(time       ,                        y,flowType,dataFlow,f1Type,npx,npy,taup);
                k2 = FUNC_rhsMoP2D_o0_inertial(time+dt    ,                  y+dt*k1,flowType,dataFlow,f1Type,npx,npy,taup);
                k3 = FUNC_rhsMoP2D_o0_inertial(time+3/4*dt,y+(1/4)*dt*k1+(1/4)*dt*k2,flowType,dataFlow,f1Type,npx,npy,taup);
                y  = y+dt*((1/6)*k1+(1/6)*k2+(2/3)*k3);
            case 4 % RK4
                k1 = FUNC_rhsMoP2D_o0_inertial(time       ,y           ,flowType,dataFlow,f1Type,npx,npy,taup);
                k2 = FUNC_rhsMoP2D_o0_inertial(time+0.5*dt,y+0.5*dt.*k1,flowType,dataFlow,f1Type,npx,npy,taup);
                k3 = FUNC_rhsMoP2D_o0_inertial(time+0.5*dt,y+0.5*dt.*k2,flowType,dataFlow,f1Type,npx,npy,taup);
                k4 = FUNC_rhsMoP2D_o0_inertial(time+dt    ,y+    dt.*k3,flowType,dataFlow,f1Type,npx,npy,taup);
...
for j=1:nt_2save-1            % loop used to save in time
    for dummyVar=1:nt_2iter-1 % loop that iterates in every time step to save
        switch timeMethod
            case 1 % EE
                k1 = FUNC_rhsMoP2D_o1_inertial(time       ,                        y,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                y  = y+dt*k1;
            case 2 % RK2
                disp('not coded')
            case 3 % RK3 TVD
                k1 = FUNC_rhsMoP2D_o1_inertial(time       ,                        y,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                k2 = FUNC_rhsMoP2D_o1_inertial(time+dt    ,                  y+dt*k1,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                k3 = FUNC_rhsMoP2D_o1_inertial(time+3/4*dt,y+(1/4)*dt*k1+(1/4)*dt*k2,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                y  = y+dt*((1/6)*k1+(1/6)*k2+(2/3)*k3);
            case 4 % RK4
                k1 = FUNC_rhsMoP2D_o1_inertial(time       ,y           ,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                k2 = FUNC_rhsMoP2D_o1_inertial(time+0.5*dt,y+0.5*dt.*k1,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                k3 = FUNC_rhsMoP2D_o1_inertial(time+0.5*dt,y+0.5*dt.*k2,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                k4 = FUNC_rhsMoP2D_o1_inertial(time+dt    ,y+    dt.*k3,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.t);
                y  = y+dt*(k1+2*k2+2*k3+k4)/6;
            otherwise
                disp('Error in timeMethod')
        end
...
for j=1:nt_2save-1            % loop used to save in time
    for dummyVar=1:nt_2iter-1 % loop that iterates in every time step to save
        switch timeMethod
            case 1 % EE
                k1 = FUNC_rhsMoP2D_o2_inertial(time       ,                        y,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                y  = y+dt*k1;
            case 2 % RK2
                disp('not coded')
            case 3 % RK3 TVD
                k1 = FUNC_rhsMoP2D_o2_inertial(time       ,                        y,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                k2 = FUNC_rhsMoP2D_o2_inertial(time+dt    ,                  y+dt*k1,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                k3 = FUNC_rhsMoP2D_o2_inertial(time+3/4*dt,y+(1/4)*dt*k1+(1/4)*dt*k2,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                y  = y+dt*((1/6)*k1+(1/6)*k2+(2/3)*k3);
            case 4 % RK4
                k1 = FUNC_rhsMoP2D_o2_inertial(time       ,y           ,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                k2 = FUNC_rhsMoP2D_o2_inertial(time+0.5*dt,y+0.5*dt.*k1,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                k3 = FUNC_rhsMoP2D_o2_inertial(time+0.5*dt,y+0.5*dt.*k2,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                k4 = FUNC_rhsMoP2D_o2_inertial(time+dt    ,y+    dt.*k3,flowType,dataFlow,f1Type,npx,npy,taup,P1.o0,P1.o1,P1.t);
                y  = y+dt*(k1+2*k2+2*k3+k4)/6;
            otherwise
                disp('Error in timeMethod')
        end
...
P1.MoM.xpxp    = a1a1*P1.o1.xp.^2        + a1a1a1*(P1.o2.xp.*P1.o1.xp + P1.o1.xp.*P1.o2.xp) + (3*a1a1^2+a1a1a1)*P1.o2.xp.^2;
P1.MoM.xpyp    = a1a1*P1.o1.xp.*P1.o1.yp + a1a1a1*(P1.o2.xp.*P1.o1.yp + P1.o1.xp.*P1.o2.yp) + (3*a1a1^2+a1a1a1)*P1.o2.xp.*P1.o2.yp;
P1.MoM.xpup    = a1a1*P1.o1.xp.*P1.o1.up + a1a1a1*(P1.o2.xp.*P1.o1.up + P1.o1.xp.*P1.o2.up) + (3*a1a1^2+a1a1a1)*P1.o2.xp.*P1.o2.up;
P1.MoM.xpvp    = a1a1*P1.o1.xp.*P1.o1.vp + a1a1a1*(P1.o2.xp.*P1.o1.vp + P1.o1.xp.*P1.o2.vp) + (3*a1a1^2+a1a1a1)*P1.o2.xp.*P1.o2.vp;
P1.MoM.ypyp    = a1a1*P1.o1.yp.^2        + a1a1a1*(P1.o2.yp.*P1.o1.yp + P1.o1.yp.*P1.o2.yp) + (3*a1a1^2+a1a1a1)*P1.o2.yp.^2;
P1.MoM.ypup    = a1a1*P1.o1.yp.*P1.o1.up + a1a1a1*(P1.o2.yp.*P1.o1.up + P1.o1.yp.*P1.o2.up) + (3*a1a1^2+a1a1a1)*P1.o2.yp.*P1.o2.up;
P1.MoM.ypvp    = a1a1*P1.o1.yp.*P1.o1.vp + a1a1a1*(P1.o2.yp.*P1.o1.vp + P1.o1.yp.*P1.o2.vp) + (3*a1a1^2+a1a1a1)*P1.o2.yp.*P1.o2.vp;
P1.MoM.upup    = a1a1*P1.o1.up.^2        + a1a1a1*(P1.o2.up.*P1.o1.up + P1.o1.up.*P1.o2.up) + (3*a1a1^2+a1a1a1)*P1.o2.up.^2;
P1.MoM.upvp    = a1a1*P1.o1.up.*P1.o1.vp + a1a1a1*(P1.o2.up.*P1.o1.vp + P1.o1.up.*P1.o2.vp) + (3*a1a1^2+a1a1a1)*P1.o2.up.*P1.o2.vp;
P1.MoM.vpvp    = a1a1*P1.o1.vp.^2        + a1a1a1*(P1.o2.vp.*P1.o1.vp + P1.o1.vp.*P1.o2.vp) + (3*a1a1^2+a1a1a1)*P1.o2.vp.^2;
