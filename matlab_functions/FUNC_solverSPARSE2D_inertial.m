...
function S1 = FUNC_solverSPARSE2D_inertial(mean_xp0,mean_yp0,mean_up0,mean_vp0, ...
...
% Splitting ---------------------------------------------------------------
nmp     = nmps(1)*nmps(2)*nmps(3)*nmps(4);
M       = max([nmps(1) nmps(2) nmps(3) nmps(4)]); % The splitting level is constant
NP      = np*nmp;
mean_a0 = dataf1.a1; clear dataf1;
                ...
                for iu=1:nmps(3)
                    for iv=1:nmps(4)
                        ...
                        elseif M == 2
                            ...
                            Lup = 2*sqrt( 0.5*upup0(jx,jy) ); Dup = 0.5*Lup;
                            Lvp = 2*sqrt( 0.5*vpvp0(jx,jy) ); Dvp = 0.5*Lvp;
                        elseif M == 3
                            Lxp = sqrt( xpxp0(jx,jy) ); Dxp = Lxp;
                            Lyp = sqrt( ypyp0(jx,jy) ); Dyp = Lyp;
                            Lup = sqrt( xpxp0(jx,jy) ); Dup = Lup;
                            Lvp = sqrt( ypyp0(jx,jy) ); Dvp = Lvp;
                        elseif M == 4
                            Lxp = sqrt( 3*xpxp0(jx,jy)/(2*1.5^2+2*0.5^2) ); Dxp = 1.5*Lxp;
                            Lyp = sqrt( 3*ypyp0(jx,jy)/(2*1.5^2+2*0.5^2) ); Dyp = 1.5*Lyp;
                            Lup = sqrt( 3*xpxp0(jx,jy)/(2*1.5^2+2*0.5^2) ); Dup = 1.5*Lup;
                            Lvp = sqrt( 3*ypyp0(jx,jy)/(2*1.5^2+2*0.5^2) ); Dvp = 1.5*Lvp;
                        elseif M == 5
                            Lxp = sqrt( 4/10 *xpxp0(jx,jy) ); Dxp = 2*Lxp;
                            Lyp = sqrt( 4/10 *ypyp0(jx,jy) ); Dyp = 2*Lyp;
                            Lup = sqrt( 4/10 *xpxp0(jx,jy) ); Dup = 2*Lup;
                            Lvp = sqrt( 4/10 *ypyp0(jx,jy) ); Dvp = 2*Lvp;
                        elseif M == 6
                            Lxp = sqrt( 5/2 *xpxp0(jx,jy)/(2.5^2+1.5^2+0.5^2) ); Dxp = 2.5*Lxp;
                            Lyp = sqrt( 5/2 *ypyp0(jx,jy)/(2.5^2+1.5^2+0.5^2) ); Dyp = 2.5*Lyp;
                            Lup = sqrt( 5/2 *xpxp0(jx,jy)/(2.5^2+1.5^2+0.5^2) ); Dup = 2.5*Lup;
                            Lvp = sqrt( 5/2 *ypyp0(jx,jy)/(2.5^2+1.5^2+0.5^2) ); Dvp = 2.5*Lvp;
                        elseif M == 7
                            Lxp = sqrt( 6/2 *xpxp0(jx,jy)/(3^2+2^2+1^2) ); Dxp = 3*Lxp;
                            Lyp = sqrt( 6/2 *ypyp0(jx,jy)/(3^2+2^2+1^2) ); Dyp = 3*Lyp;
                            Lup = sqrt( 6/2 *xpxp0(jx,jy)/(3^2+2^2+1^2) ); Dup = 3*Lup;
                            Lvp = sqrt( 6/2 *ypyp0(jx,jy)/(3^2+2^2+1^2) ); Dvp = 3*Lvp;
                        elseif M == 8
                            Lxp = sqrt( 7/2 *xpxp0(jx,jy)/(3.5^2+2.5^2+1.5^2+0.5^2) ); Dxp = 3.5*Lxp;
                            Lyp = sqrt( 7/2 *ypyp0(jx,jy)/(3.5^2+2.5^2+1.5^2+0.5^2) ); Dyp = 3.5*Lyp;
                            Lup = sqrt( 7/2 *xpxp0(jx,jy)/(3.5^2+2.5^2+1.5^2+0.5^2) ); Dup = 3.5*Lup;
                            Lvp = sqrt( 7/2 *ypyp0(jx,jy)/(3.5^2+2.5^2+1.5^2+0.5^2) ); Dvp = 3.5*Lvp;
                        end
                        dataf1.a1(jx,jy,k) = mean_a0(jx,jy);
                        mean_xp0s(jx,jy,k) = mean_xp0(jx,jy) - Dxp + (ix-1)*Lxp;
                        mean_yp0s(jx,jy,k) = mean_yp0(jx,jy) - Dyp + (iy-1)*Lyp;
                        mean_up0s(jx,jy,k) = mean_up0(jx,jy) - Dup + (iu-1)*Lup;
                        mean_vp0s(jx,jy,k) = mean_vp0(jx,jy) - Dvp + (iv-1)*Lvp;
                        xpxp0s(jx,jy,k)    = xpxp0(jx,jy)/M;
                        xpyp0s(jx,jy,k)    = xpyp0(jx,jy);
                        xpup0s(jx,jy,k)    = xpup0(jx,jy);
                        xpvp0s(jx,jy,k)    = xpvp0(jx,jy);
                        ypyp0s(jx,jy,k)    = ypyp0(jx,jy)/M;
                        ypup0s(jx,jy,k)    = ypup0(jx,jy);
                        ypvp0s(jx,jy,k)    = ypvp0(jx,jy);
                        upup0s(jx,jy,k)    = upup0(jx,jy)/M;
                        upvp0s(jx,jy,k)    = upvp0(jx,jy);
                        vpvp0s(jx,jy,k)    = vpvp0(jx,jy)/M;
                        k = k + 1;
                    end
                end
            end
...
for j=1:nt(1)
    for ix=1:npx
        for iy=1:npy
            ...
            T                     = abs(S1.t(j)-tLim(1));
            S1.FTLE(ix,iy,j)      = 1/T*log(sqrt(S1.maxEigKxp(ix,iy,j)/S1.maxEigKxp(ix,iy,1)));
...
%             S1.FTLEv(ix,iy,j)     = (1/(S1.t(j)-tLim(1)))*log(sqrt(S1.maxEigKup(ix,iy,j)/S1.maxEigKup(ix,iy,1)));
            S1.FTLEv(ix,iy,j)     = 1/T*log(sqrt(S1.maxEigKup(ix,iy,j)));
