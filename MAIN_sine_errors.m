...
fig      = figure('units','inches','outerposition',[1 1 13+1 5+1],'color','w');
iFig     = fig.Number;
[ha,pos] = tight_subplot(4,1,[0.065 0.01],0.1,0.06);

axes(ha(1)) % close all
% subplot(411)
plot(P1.t/1,e1_mean_xp,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,e3_mean_xp,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,e5_mean_xp,'-.','linewidth',lw,'color',color14); hold on
leg = legend('$St=1$','$St=3$','$St=5$', ...
    'interpreter','latex','fontsize',0.6*fs,'location','northwest');
leg.Box = 'off';
leg.NumColumns = 5;
...
% subplot(412)
axes(ha(2)) % close all
plot(P1.t/1,e1_mean_up,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,e3_mean_up,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,e5_mean_up,'-.','linewidth',lw,'color',color14); hold on
...
% subplot(413)
axes(ha(3)) % close all
plot(P1.t/1,e1_sigma_xp,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,e3_sigma_xp,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,e5_sigma_xp,'-.','linewidth',lw,'color',color14); hold on
...
% subplot(414)
axes(ha(4)) % close all
plot(P1.t/1,e1_sigma_up,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,e3_sigma_up,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,e5_sigma_up,'-.','linewidth',lw,'color',color14); hold on
...
axes(ha(1)) % close all
% subplot(411)
plot(P1.t/1,se1_mean_xp,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,se3_mean_xp,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,se5_mean_xp,'-.','linewidth',lw,'color',color14); hold on
leg = legend('$St=1$','$St=3$','$St=5$', ...
    'interpreter','latex','fontsize',0.6*fs,'location','northwest');
leg.Box = 'off';
leg.NumColumns = 5;
...
% subplot(412)
axes(ha(2)) % close all
plot(P1.t/1,se1_mean_up,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,se3_mean_up,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,se5_mean_up,'-.','linewidth',lw,'color',color14); hold on
ylabel('$\varepsilon(\overline{V}_1)$','interpreter','latex','fontsize',fs)
ax = gca;
ax.TickLabelInterpreter = 'latex';
ax.FontSize=0.6*fs; 
...
% subplot(413)
axes(ha(3)) % close all
plot(P1.t/1,se1_sigma_xp,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,se3_sigma_xp,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,se5_sigma_xp,'-.','linewidth',lw,'color',color14); hold on
ylabel('$\varepsilon(\sigma_{Y_1})$','interpreter','latex','fontsize',fs)
ax = gca;
ax.TickLabelInterpreter = 'latex';
ax.FontSize=0.6*fs; 
...
% subplot(414)
axes(ha(4)) % close all
plot(P1.t/1,se1_sigma_up,'-','linewidth',lw,'color',color9); hold on
plot(P3.t/3,se3_sigma_up,'--','linewidth',lw,'color',color10); hold on
plot(P5.t/5,se5_sigma_up,'-.','linewidth',lw,'color',color14); hold on
ylabel('$\varepsilon(\sigma_{V_1})$','interpreter','latex','fontsize',fs)
xlabel('$t/St$','interpreter','latex','fontsize',fs)
ax = gca;
ax.TickLabelInterpreter = 'latex';
...
plot(P5.t/5,se5_mean_xp,'-.','linewidth',lw,'color',color14); hold on
leg = legend('$St=1$','$St=3$','$St=5$', ...
    'interpreter','latex','fontsize',0.6*fs,'location','best');
leg.Box = 'off';
leg.NumColumns = 5;
ylabel('$\varepsilon(\overline{Y}_1)$','interpreter','latex','fontsize',fs)
ax = gca;
